...
# Uses 1 main wikipedia page and then loops over support wikipedia pages to revise the script.
...
def main():
    ...
    for revision_num, wikipedia_page_title in enumerate(config.support_wikipedia_pages):
...
def generate_initial_script(client):
    ...
    # Load main Wikipedia page
    wikipedia_prompt_data = load_wikipedia_page(config.main_wikipedia_page)
    ...
    prompt = (
        ...
        f"You'll be given a Wikipedia page at the end of this prompt covering the subject. "
